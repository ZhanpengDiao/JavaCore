// using a synchronized queue, which can ignore synchronized issues
...
public class UseBlockingQueues {
    static void getKey() {
        try {
    ...
    static void test(String msg, BlockingQueue<LiftOff> queue) {
        ...
        t.start();
        for(int i = 0; i < 5; i ++) runner.add(new LiftOff(5));
        getKey("Press 'Enter' (" + msg + ")"); // get signal to continue
        t.interrupt();
